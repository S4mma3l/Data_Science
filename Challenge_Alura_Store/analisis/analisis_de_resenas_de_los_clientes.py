...
# Agrupamos los datos por tienda (implícitamente al procesar cada DataFrame)
# y calculamos la media de la columna 'Calificación'
...
plt.ylim(0, 5)  # Asumimos que la calificación está en una escala de 1 a 5
plt.tight_layout()
plt.show()
