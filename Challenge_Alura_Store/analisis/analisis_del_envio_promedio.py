...
# --- 2. Calcular el costo de envío promedio para cada tienda ---

# Calculamos el promedio de la columna 'Costo de envío' para cada DataFrame
...
# --- 3. Crear un DataFrame para comparar los costos de envío promedio ---
